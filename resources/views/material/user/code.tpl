							...
							<div class="card-main">
								<div class="card-inner">
									<div class="card-inner">
										...
										<p>本页面会教你如何充值与购买的,请按照步骤进行.谢谢!.</p>
										<p>充值后请在左侧菜单栏选择"商店"进行流量购买,或者<a href="http://niuxsd.cn/user/shop">点我进入商店</a>.</p>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-12 col-md-12">
						<div class="card margin-bottom-no">
							<div class="card-main">
								<div class="card-inner">
									<div class="card-inner">
										<p class="card-heading">1  购买充值码</p>
										<p>点击下方的充值,并进行购买,单次最低充5元,选择合适的金额购买后,便会得到充值码.</p>
										<p>购买完成后回到本页面！</p>
									</div>
									<div class="card-action">
										<div class="card-action-btn pull-left">
											<a href="http://t.cn/RO5yQK8" target="_blank"><button class="btn btn-flat waves-attach"><span class="icon">shopping_cart</span>&nbsp;充值</button></a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-12 col-md-12">
						<div class="card margin-bottom-no">
							<div class="card-main">
								<div class="card-inner">
									<div class="card-inner">
										<p class="card-heading">2  使用充值码</p>
										<p>将之前购买到的充值码复制到下面</p>
										<div class="form-group form-group-label">
											<label class="floating-label" for="code">在此输入你的充值码</label>
