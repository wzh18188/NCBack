...
<head>
	...
	<meta name="theme-color" content="#ef8b94">
	<meta name="apple-mobile-web-app-title" content="yes" />
	<meta name="apple-mobile-web-app-capable" content="yes" />
	<meta name="apple-mobile-web-app-status-bar-style" content="#ef8b94">
	...
	<style>
		...
		.page-green .ui-content-header {
			background-image: url(/theme/material/css/images/bg/bg1.jpg);
		}
...
<body class="page-green">
	<header class="header header-green header-transparent header-waterfall ui-header">
			...
			<div class="dropdown margin-right">
				...
				{if $user->isLogin}
					...
					<ul class="dropdown-menu dropdown-menu-right">
						<li>
							<a class="padding-right-lg waves-attach" href="/user/"><span class="icon icon-lg margin-right">account_box</span>首页</a>
						</li>
						<li>
							<a class="padding-right-lg waves-attach" href="http://t.cn/RO5yQK8"><span class="icon icon-lg margin-right">attach_money</span>充值</a>
						</li>
						<li>
	...
	<nav aria-hidden="true" class="menu menu-left nav-drawer nav-drawer-md" id="ui_menu" tabindex="-1">
		<div class="menu-scroll">
			<div class="menu-content">
				<a class="menu-logo" href="/"><i class="icon icon-lg">face</i>&nbsp;用户面板</a>
				<ul class="nav">
					<li>
					...
					<!--		<li>
								<a href="/user/invite">
									<i class="icon icon-lg">loyalty</i>&nbsp;我的邀请码
								</a>
							</li>   -->
							
							<li>
							    <a href="/user/logout">
								      <i class="icon icon-lg">exit_to_app</i>&nbsp;退出账户
								</a>
							</li>
						...
						<ul class="menu-collapse collapse in" id="ui_menu_trade">
							...
							<li>
								<a href="/user/ticket">
									<i class="icon icon-lg">mode_comment</i>&nbsp;工单系统
								</a>
							</li>
							
							<li>
								<a href="http://blog.ncback.win" target="_blank">
									<i class="icon icon-lg">help</i>&nbsp;使用教程(施工ing)
								</a>
							</li>
                      ...
                      <a class="waves-attach" data-toggle="collapse" href="#ui_menu_others">其他</a>
						<ul class="menu-collapse collapse in" id="ui_menu_others">
						
						
							<li>
								<a href="http://download.ncback.win">
									<i class="icon icon-lg">file_download</i>&nbsp;下载站
								</a>
							</li>
							
							<li><a href="http://blog.ncback.win" target="_blank"><i class="icon icon-lg">blur_circular</i>&nbsp;论坛</a></li>
