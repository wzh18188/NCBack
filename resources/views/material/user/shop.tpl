					...
					<div class="card">
						<div class="card-main">
							<div class="card-inner">
								<p class="card-heading">当前余额：<b>{$user->money}</b> 元</p>
								<p>系统中所有商品的列表.您购买等级类的商品时有效期会<b>从当前时间开始计算.</b></p>
								<p>流量套餐支持叠加购买</p>
								<p>若需要自动续费,请确认是否有充足的余额</p>
							</div>
						</div>
					</div>
					...
					<div class="table-responsive">
						...
						<table class="table ">
                            ...
                            <tr>
                                ...
                                <td>无法自动续费</td>
								{else}
								<td>可在<b>{$shop->auto_renew}</b>天后自动续费</td>
								{/if}
