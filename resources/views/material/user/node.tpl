						...
						<div class="card margin-bottom-no">
							<div class="card-main">
								<div class="card-inner">
									...
									<p>点击某一个节点名称可以单独查看当前节点的详细配置方法.</p>
									<a href="http://blog.ncback.win" target="_blank">如果您不知道如何使用,可以点我哟</a>
									<p>*请在使用节点前先查看当前节点的流量计费方式</p>
								</div>
							</div>
						</div>
					</div>
																		...
																		<div class="card-main">
																			...
																			{if $node->sort == 0||$node->sort==7||$node->sort==8||$node->sort==10}
																				...
																				{if ($node->sort==0||$node->sort==7||$node->sort==8||$node->sort==10)&&($node->node_speedlimit!=0||$user->node_speedlimit!=0)}
																					<p>节点限速:&nbsp; <span class="label label-brand">
					...
					<div class="col-lg-12 col-md-12">
						<div class="card margin-bottom-no">
							<div class="card-main">
								<div class="card-inner">
									<h4>节点信息视图介绍</h4>
									<p><i class="icon icon-lg">person</i> 此节点当前在线人数</p>
									<p> <i class="icon icon-lg">build</i> 是否支持手动修改</p>
									<p> <i class="icon icon-lg">traffic</i> 此节点本月累计流量 / 是否限流</p>
									<p> <i class="icon icon-lg">warning</i> 流量比例,计算方式为"实际使用*比例值"</p>
								</div>
							</div>
						</div>
					</div>
